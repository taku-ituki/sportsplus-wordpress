    ...
    function setMatcher(preFilter, selector, matcher, postFilter, postFinder, postSelector) {
      ...
      return markFunction(function (seed, results, context, xml) {
        var temp,
          ...
          matcherIn = preFilter && (seed || !selector) ? condense(elems, remap, preFilter, context, xml) : elems;
        if (matcher) {
        ...
        if (seed) {
          if (postFinder || preFilter) {
            ...
            i = matcherOut.length;
            while (i--) {
              if ((elem = matcherOut[i]) && (temp = postFinder ? indexOf.call(seed, elem) : remap[i]) > -1) {
                ...
                var that = this,
                  ...
                  mightThrow = function mightThrow() {
                    ...
                    then =
                      ...
                      (_typeof(returned) === "object" || typeof returned === "function") &&
                      returned.then;
